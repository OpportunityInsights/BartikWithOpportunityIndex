...
global home "/nfs/home/P/per023/shared_space/per023_proj"
...
collapse (sum) pop1980=perwt_cz_lf if year==1980, by(czone  ageDecile educ_coll_lt4yrs educ_coll_4yrs)
...
gen natindwt2 = natindwt + indwt 
/*	//reverse the "Leave-Out"
drop nat_empl_ind_
...
keep if year!=2010
*/
save "${home}/input_BAR2`fileSuffix'", replace
}
}
